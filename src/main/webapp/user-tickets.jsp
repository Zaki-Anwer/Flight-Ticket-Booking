...
<body >
		...
		<%
	       ...
	       String userID = (String) session.getAttribute("userEmail");
		    ...
		    List<FlightBookingDetails> bookingDetails=bookingDao.getTicketByEmail(userID);
		%>
		...
		<div class="table-box" >
			<table>
			 <tr>
				...
				<%
				for(FlightBookingDetails bookingDetails1:bookingDetails){
					 if (bookingDetails1 != null && bookingDetails1.getUserid() != null && bookingDetails1.getUserid().equalsIgnoreCase(userID))
					 {
				       session.setAttribute("userEmail", bookingDetails1.getUserid());
				     
					 }
					
				%>
					<%if(bookingDetails1.getFlightName().equalsIgnoreCase("indigo")){%>
						<tr  class="table-row">
							...
							<td><%=bookingDetails1.getPnr()%></td>	
							<td><%=bookingDetails1.getFlightNumber()%></td>
							<td><%=bookingDetails1.getName()%></td>
							<td><%=bookingDetails1.getGender()%></td>
							<td><%=bookingDetails1.getPrice()%></td>				
		     				<td><%=bookingDetails1.getFlightSource() %></td>	
							<td><%=bookingDetails1.getFlightDestination() %></td>	
							<td><%=bookingDetails1.getDepartureTime() %></td>	
							<td><%=bookingDetails1.getArrivalTime() %></td>	
							<td><a href="getTicket?Prn=<%=bookingDetails1.getPnr()%>" class="download">Print</a></td>	
							
						</tr>
					<%}%>
					<%if(bookingDetails1.getFlightName().equalsIgnoreCase("vistra")){%>
						<tr  class="table-row">
					...
					<%if(bookingDetails1.getFlightName().equalsIgnoreCase("SpaceJet")){%>
						<tr  class="table-row">
					...
					<%if(bookingDetails1.getFlightName().equalsIgnoreCase("Air Aysha")){%>
						<tr  class="table-row">
					...
					<%if(bookingDetails1.getFlightName().equalsIgnoreCase("Akasha Air")){%>
						<tr  class="table-row">
					...
					<%if(bookingDetails1.getFlightName().equalsIgnoreCase("Air India")){%>
						<tr  class="table-row">
